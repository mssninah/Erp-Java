...
//         HttpHeaders headers = new HttpHeaders();
//         headers.setContentType(MediaType.APPLICATION_JSON);
//         headers.set("Cookie", "sid=" + sid);  // Ajouter le cookie sid pour authentification
...
//         String url = UriComponentsBuilder.fromHttpUrl(erpNextBaseUrl)
//                 .path("/api/method/erpnext.api.data.get_supplier_quotations")
//                 .queryParam("supplier", supplier)
//                 .toUriString();
...
//     String url = UriComponentsBuilder.fromHttpUrl(erpNextBaseUrl)
//             .path("/api/resource/Supplier Quotation/" + quotationId)  // Utiliser un espace non encodé ici
//             .build(false) // Désactiver l'encodage automatique
//             .toString();
...
//     String url = UriComponentsBuilder.fromHttpUrl(erpNextBaseUrl)
//             .path("/api/method/erpnext.api.data.get_purchase_orders")
//             .queryParam("supplier", supplier)
//             .toUriString();
...
//     // Construire l'URL sans double encodage
//     String url = UriComponentsBuilder.fromHttpUrl(erpNextBaseUrl)
//             .path("/api/resource/Purchase Order/" + purchaseOrderId)  // Utiliser l'ID de la commande d'achat
//             .build(false) // Désactiver l'encodage automatique
//             .toString();
